...
plot_select_one(datalist = datalist, dico = dico, "HOT_LINE.deficiente_cal", datasource = params$datasource)
plot_select_one_cross(datalist = datalist, dico = dico, "HOT_LINE.deficiente_cal","group_Demographic.group_nv8at35.sex", datasource = params$datasource)
plot_select_one_cross(datalist = datalist, dico = dico, "HOT_LINE.deficiente_cal","group_Demographic.group_nv8at35.age", datasource = params$datasource)
...
plot_select_one(datalist = datalist, dico = dico, "RETROALIMENTACION.quejas_02")
plot_select_one_cross(datalist = datalist, dico = dico, "RETROALIMENTACION.quejas_02","group_Demographic.group_nv8at35.sex")
plot_select_one_cross(datalist = datalist, dico = dico, "RETROALIMENTACION.quejas_02","group_Demographic.group_nv8at35.age")
plot_text(datalist = datalist, dico = dico, "RETROALIMENTACION.quejas_other")
plot_text(datalist = datalist, dico = dico, "RETROALIMENTACION.quejas_mejora")
```
